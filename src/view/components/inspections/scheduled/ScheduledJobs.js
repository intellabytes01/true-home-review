...
class ScheduledJobs extends React.PureComponent {
    constructor(props) {
        super(props)
        this.state = {
            addNewPopup: false,
    ...
    componentDidMount() {
        ...
        setTimeout(()=>{
            ...
            let page_no = localStorage.getItem("incomp_page_no")
            this.props.updateIt(0, page_no)
            console.log("inCompletedJobs mounted ");
        })  
