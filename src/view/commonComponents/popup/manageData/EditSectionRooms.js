...
const EditSectionRoom = ({response,data,handleEdit, toggleEditSectionRoom, options, editSectionRoom }) => {
    
   
   return <div>
        {/* <Button color="danger" onClick={togglePlansPopup}>{this.props.buttonLabel}</Button> */}
        <Modal isOpen={editSectionRoom} toggle={toggleEditSectionRoom} style={{ maxWidth: '400px' }}>
            {/* <ModalHeader toggle={togglePlansPopup}>Modal title</ModalHeader> */}
            <div className="popup-wrapper">
                <ModalBody>
                    <div className="popup-header text-center">
                        <h2>Edit Section Rooms</h2>
                    </div>
                    ...
                    onSubmit={(values, formikBag)=>handleEdit({values,formikBag,moduleName:END_POINT.CREATE_UPDATE_LISTDATA.END_POINTS.SECTION_ROOM})}
                            ...
                            <div className="pop-form-wrapper">
                                <div className="row">
                                    <div className="col-md-12 pl-2 pr-2">
                                        ...
                                        {/* <SelectBox
                                        selectClass="form-group wrapper-searchable"
...
export default EditSectionRoom;