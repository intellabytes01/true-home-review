...
const BuilderAdd = ({response,handleNew, toggleBuilderAdd, builderAdd }) => (
    <div>
        {/* <Button color="danger" onClick={togglePlansPopup}>{this.props.buttonLabel}</Button> */}
        <Modal isOpen={builderAdd} toggle={toggleBuilderAdd} style={{ maxWidth: '300px' }}>
            ...
            <div className="popup-wrapper">
                <ModalBody>
                    ...
                    onSubmit={(values, formikBag)=>handleNew({values,formikBag,moduleName:END_POINT.CREATE_UPDATE_LISTDATA.END_POINTS.BUILDER})}
