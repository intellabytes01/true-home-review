        ...
        <Modal isOpen={editGeneric} toggle={toggleEditGeneric} style={{ maxWidth: '400px' }}>
            ...
            <div className="popup-wrapper">
                <ModalBody>
                    ...
                    onSubmit={(values, formikBag)=>handleEdit({values,formikBag,moduleName:END_POINT.CREATE_UPDATE_LISTDATA.END_POINTS.GENERIC})}
