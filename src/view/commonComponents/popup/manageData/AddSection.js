...
const AddSection = ({response,handleNew, toggleAddSection, addSection }) => (
    <div>
        {/* <Button color="danger" onClick={togglePlansPopup}>{this.props.buttonLabel}</Button> */}
        <Modal isOpen={addSection} toggle={toggleAddSection} style={{ maxWidth: '400px' }}>
            ...
            <div className="popup-wrapper">
                <ModalBody>
                    ...
                    onSubmit={(values, formikBag)=>handleNew({values,formikBag,moduleName:END_POINT.CREATE_UPDATE_LISTDATA.END_POINTS.SECTION})}
                            ...
                            <div className="pop-form-wrapper">
                                <div className="row">
                                    <div className="col-md-12 pl-2 pr-2">
                                        <InputBox
                                            formWrapClass="form-group wrapper-searchable"
