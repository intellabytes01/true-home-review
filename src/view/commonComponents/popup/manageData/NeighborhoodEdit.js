...
const NeighborhoodEdit = ({response,handleEdit,data, toggleNeighborhoodEdit, neighborhoodEdit }) => (
    <div>
        {/* <Button color="danger" onClick={togglePlansPopup}>{this.props.buttonLabel}</Button> */}
        <Modal isOpen={neighborhoodEdit} toggle={toggleNeighborhoodEdit} style={{ maxWidth: '300px' }}>
            ...
            <div className="popup-wrapper">
                <ModalBody>
                    ...
                    onSubmit={(values, formikBag)=>handleEdit({values,formikBag,moduleName:END_POINT.CREATE_UPDATE_LISTDATA.END_POINTS.NEIGHBORHOOD})}
